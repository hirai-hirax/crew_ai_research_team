...
2. **カレンダー分析**: Google カレンダーから直近の外出傾向を読み解き、好みを推定
3. **ローカル調査**: エリア内のイベントや施設を Web 検索し、屋内/屋外で分類
4. **推薦作成**: 情報を統合し、本命・気分転換・雨天向けの 3 候補を提示
5. **交通計画**: Google Maps API を使用して本命候補への移動手段・所要時間・概算料金を整理
6. **カレンダー登録**: 予定を Google カレンダーに登録できるテンプレートを作成
